...
import accelerator.powers.VacuumPower;
import basemod.abstracts.CustomCard;

public class Vacuum extends CustomCard{
	...
	public void use(AbstractPlayer p, AbstractMonster m) {		
		AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p, p, new VacuumPower(p, this.magicNumber), this.magicNumber));
	}
}
