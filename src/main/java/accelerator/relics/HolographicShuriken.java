...
public class HolographicShuriken extends ChannelRelic {
	public static final String ID = "HolographicShuriken";
		
	public HolographicShuriken() {
	...
	public AbstractRelic makeCopy() {
		return new HolographicShuriken();
	}
